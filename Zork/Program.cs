...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            roomMap["Canyon View"].Description = "You are at the top of the Great Canyon on ots south wall.";                                                   // Canyon View
            ...
            roomMap["Behind House"].Description = "You are behind the white house. In the corner of the house there is a small window which is slightly ajar."; // Behind House
